  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      h1,
      h2 {
        font-family: var(--typography-font-heading, "Space Grotesk", sans-serif);
      }
      .slide-title {
...
<div
  ...
  style="width: min(80%, 600px); height: clamp(200px, 40vh, 350px);"
>
...
```html
<div
  class="slide slide-with-bg"
  style="background-image: url('https://images.pexels.com/...')"
>
  <div
    class="overlay"
    style="background: linear-gradient(135deg, rgba(13,13,13,0.9), rgba(13,13,13,0.7))"
  ></div>
  <div
    class="content"
