...
export const DASHBOARD_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    kind: "rank_drop",
    severity: "warning",
    title: "Rank drop — Baptist Memorial Hospital - Memphis",
    body: '"walk-in clinic memphis" dropped out of the top 10 average positions since the last geo-grid scan.',
    ts: "2026-07-15T09:20:00Z",
  ...
  },
  {
    ...
    kind: "review",
    severity: "info",
    title: "3 reviews need replies",
    body: "Baptist Memorial Hospital - Collierville has 3 new reviews waiting in the response queue.",
    ts: "2026-07-15T07:05:00Z",
    href: "/locations/baptist-collierville/reviews",
    location_slug: "baptist-collierville",
    audience: "all",
    source: "synthetic",
  },
  {
    ...
    kind: "nap_drift",
    severity: "warning",
    title: "NAP drift — 4 listings",
    body: "Baptist Memorial Hospital - DeSoto has 4 directory listings out of sync with the canonical NAP.",
    ts: "2026-07-14T16:40:00Z",
    href: "/locations/baptist-desoto/citations",
  ...
  },
  {
    ...
    kind: "run",
    severity: "success",
    title: "AI surface bake completed",
    body: "Fleet-wide AI visibility check finished across all 5 locations — 400 calls, 0 errors.",
    ts: "2026-06-30T19:06:00Z",
    href: "/system/runs/run-014",
    location_slug: null,
    audience: "all",
    source: "dataforseo",
  },
  {
    ...
    kind: "ai_visibility",
    severity: "success",
    title: "AI visibility gained — Baptist North Mississippi",
    body: "Baptist Memorial Hospital - North Mississippi now appears in the AI Overview for a core service query.",
    ts: "2026-07-13T11:15:00Z",
    href: "/locations/baptist-north-mississippi/local-ai",
    location_slug: "baptist-north-mississippi",
    audience: "all",
    source: "synthetic",
  },
  {
    ...
    kind: "run",
    severity: "error",
    title: "Run failed — AI spot check (DeSoto)",
    body: "6 of 6 provider calls timed out on the retry run for Baptist Memorial Hospital - DeSoto.",
    ts: "2026-06-22T20:16:35Z",
  ...
  },
  {
    ...
    kind: "citations",
    severity: "info",
    title: "New citation gained — Baptist Memphis",
    body: "A new directory listing for Baptist Memorial Hospital - Memphis was indexed this cycle.",
    ts: "2026-07-12T08:30:00Z",
    href: "/locations/baptist-memphis/citations",
    location_slug: "baptist-memphis",
    audience: "all",
    source: "searchatlas",
  },
  {
    ...
    kind: "posts",
    severity: "info",
    title: "Post published — Baptist Collierville",
    body: "A scheduled GBP post for Baptist Memorial Hospital - Collierville went live.",
    ts: "2026-07-11T14:00:00Z",
    href: "/locations/baptist-collierville/posts",
    location_slug: "baptist-collierville",
    audience: "all",
    source: "synthetic",
  },
  {
    ...
    kind: "gbp_health",
    severity: "warning",
    title: "GBP health score dropped — Baptist DeSoto",
    body: "Baptist Memorial Hospital - DeSoto's Google Business Profile health score fell into the at-risk band.",
    ts: "2026-07-11T09:45:00Z",
    href: "/locations/baptist-desoto/gbp-health",
    location_slug: "baptist-desoto",
    audience: "all",
    source: "synthetic",
  },
  {
    ...
    kind: "review",
    severity: "success",
    title: "Review reply approved & posted",
    body: "An operator-drafted reply for Baptist Memorial Hospital - North Mississippi was approved and posted.",
    ts: "2026-07-10T13:20:00Z",
    href: "/locations/baptist-north-mississippi/reviews",
    location_slug: "baptist-north-mississippi",
    audience: "all",
    source: "synthetic",
  },
...
export const STUB_NOTIFICATIONS: BellItem[] = DASHBOARD_NOTIFICATIONS.map((n) => ({
  id: n.id,
  audience: n.audience,
}));
...
import type { NAPFile, RunsFixture, ReportsFixture, LocationsFile } from "@/lib/data/types";

export const DASHBOARD_NAP_FILE: NAPFile = {
  generated_at: "2026-07-10T00:00:00Z",
  source_note: "Canonical NAP per location",
  canonical: {
    "baptist-memphis": {
      name: "Baptist Memorial Hospital - Memphis",
      address: "6019 Walnut Grove Rd, Memphis, TN",
    ...
    "baptist-desoto": {
      name: "Baptist Memorial Hospital - DeSoto",
      address: "7601 Southcrest Pkwy, Southaven, MS",
      phone: "(662) 772-4000",
      website: "https://www.baptistmedicalclinic.org/locations/desoto",
      source: "dataforseo",
    },
    "baptist-north-mississippi": {
      name: "Baptist Memorial Hospital - North Mississippi",
      address: "1100 Belk Blvd, Oxford, MS",
      phone: "(662) 636-1000",
      website: "https://www.baptistmedicalclinic.org/locations/north-ms",
      source: "dataforseo",
    },
    "baptist-golden-triangle": {
      name: "Baptist Memorial Hospital - Golden Triangle",
      address: "2520 5th St N, Columbus, MS",
      phone: "(662) 244-1000",
      website: "https://www.baptistmedicalclinic.org/locations/golden-triangle",
      source: "dataforseo",
    },
  },
...
export const DASHBOARD_RUNS: RunsFixture = {
  source: "synthetic",
  generated_at: "2026-07-10T00:00:00Z",
  note: "Run receipts for the 5-location fleet",
  runs: [
    {
      id: "run-014",
      kind: "ai_surface_check",
      label: "AI surface bake - full fleet",
      trigger: "manual",
      triggered_by: "Agency Operator",
      status: "succeeded",
      started_at: "2026-06-30T18:42:00Z",
      duration_s: 1980,
      provider: "dataforseo",
      calls: 400,
      errors: 0,
      cost_usd: 8.52,
      cost_note: "billed",
      location_scope: "All 5 locations",
      source: "dataforseo",
      steps: [
        {
          ...
          status: "succeeded",
          duration_s: 4,
          detail: "5 locations x 2 queries x 6 surfaces -> 60 checks",
        },
        {
          name: "Fire chatbot checks",
          status: "succeeded",
          duration_s: 1240,
          detail: "Live LLM responses via DataForSEO AI endpoints",
        },
        {
          name: "Fire Google checks",
          status: "succeeded",
          duration_s: 610,
          detail: "Geolocated SERPs from each location's coordinates",
        },
        {
          name: "Parse citations & mentions",
          status: "succeeded",
          duration_s: 88,
          detail: "Domain extraction, baptistonline.org + practice domains matched",
        },
        {
          name: "Recompute LVI",
          status: "succeeded",
          duration_s: 2,
          detail: "Portfolio LVI recomputed",
        },
        {
          name: "Write fixtures",
          status: "succeeded",
          duration_s: 3,
          detail: "fixtures refreshed with evidence",
        },
      ],
      artifacts: [
        { label: "Fleet dashboard (LVI)", href: "/local" },
        { label: "Baptist Memphis - AI visibility", href: "/locations/baptist-memphis/local-ai" },
      ],
      log: [
        { ts: "2026-06-30T18:42:01Z", level: "info", msg: "matrix built: 60 checks queued" },
        { ts: "2026-06-30T18:53:22Z", level: "info", msg: "chatbot pass complete" },
        { ts: "2026-06-30T19:04:40Z", level: "info", msg: "google pass complete" },
        { ts: "2026-06-30T19:06:12Z", level: "info", msg: "spend $8.52 - receipts archived" },
      ],
    },
    {
      id: "run-013",
      kind: "geo_grid_scan",
      label: "Geo-grid refresh - Baptist Memphis",
      trigger: "manual",
      triggered_by: "Agency Operator",
      status: "succeeded",
      started_at: "2026-06-28T15:10:00Z",
      duration_s: 340,
      provider: "searchatlas",
      calls: 3,
      errors: 0,
      cost_usd: 0,
      cost_note: "plan credits",
      location_scope: "Baptist Memorial Hospital - Memphis",
      source: "searchatlas",
      steps: [
        {
          name: "Fetch grid snapshot dates",
          status: "succeeded",
          duration_s: 6,
          detail: "3 snapshots available",
        },
        {
          name: "Pull per-pin location report",
          status: "succeeded",
          duration_s: 310,
          detail: "per snapshot",
        },
        {
          ...
          status: "succeeded",
          duration_s: 24,
          detail: "ATRP/SoLV recomputed",
        },
      ],
      artifacts: [
        { label: "Baptist Memphis - Geo-Grid", href: "/locations/baptist-memphis/geo-grid" },
      ],
      log: [
        { ts: "2026-06-28T15:10:06Z", level: "info", msg: "snapshots loaded" },
        { ts: "2026-06-28T15:15:40Z", level: "info", msg: "100 pins x 3 snapshots parsed" },
      ],
    },
    {
      id: "run-012",
      kind: "citation_baseline",
      label: "Citation baseline rebuild - authority scores",
      trigger: "manual",
      triggered_by: "Agency Operator",
      status: "succeeded",
      started_at: "2026-06-27T21:30:00Z",
      duration_s: 95,
      provider: "dataforseo",
      calls: 4,
      errors: 0,
      ...
      steps: [
        {
          name: "Pull directory domain ranks",
          status: "succeeded",
          duration_s: 60,
          detail: "directories scored via backlinks",
        },
        {
          name: "Rebuild per-location rows",
          status: "succeeded",
          duration_s: 30,
          detail: "rows x 5 locations",
        },
        {
          name: "Write fixtures",
          status: "succeeded",
          duration_s: 5,
          detail: "source-tagged per row",
        },
      ],
      artifacts: [
        { label: "Baptist Memphis - Citations", href: "/locations/baptist-memphis/citations" },
      ],
      log: [{ ts: "2026-06-27T21:31:35Z", level: "info", msg: "authority scores merged" }],
    },
    {
      id: "run-011",
      kind: "gbp_audit",
      label: "GBP audit snapshot - fleet",
      trigger: "manual",
      triggered_by: "Agency Operator",
      status: "succeeded",
      started_at: "2026-06-26T16:05:00Z",
      duration_s: 720,
      provider: "searchatlas",
      calls: 5,
      errors: 0,
      ...
      source: "searchatlas",
      steps: [
        { name: "Pull audit report", status: "succeeded", duration_s: 45, detail: "real artifact" },
        {
          name: "Snapshot fleet audits",
          status: "succeeded",
          duration_s: 640,
          detail: "5 locations",
        },
        {
          name: "Score scorecards",
          status: "succeeded",
          duration_s: 35,
          detail: "listing_type-aware scoring",
        },
      ],
      artifacts: [
        { label: "Baptist Memphis - GBP Health", href: "/locations/baptist-memphis/gbp-health" },
      ],
      log: [{ ts: "2026-06-26T16:17:00Z", level: "info", msg: "5/5 audits scored" }],
    },
    {
      id: "run-010",
      kind: "enrichment",
      label: "Fleet enrichment - hours, categories, coordinates",
      trigger: "manual",
      triggered_by: "Agency Operator",
      status: "succeeded",
      ...
      steps: [
        {
          name: "Business listings search",
          status: "succeeded",
          duration_s: 210,
          detail: "CIDs resolved",
        },
        {
          name: "Write locations fixture",
          status: "succeeded",
          duration_s: 50,
          detail: "fixtures updated",
        },
      ],
      artifacts: [{ label: "All locations", href: "/local" }],
      log: [{ ts: "2026-06-25T14:04:20Z", level: "info", msg: "5/5 locations enriched" }],
    },
    {
      id: "run-009",
      kind: "review_sync",
      label: "Scheduled review sync - fleet",
      trigger: "scheduled",
      ...
      steps: [
        {
          name: "Pull new reviews",
          status: "succeeded",
          duration_s: 120,
          detail: "3 new reviews since last sync",
        },
        {
          name: "Flag reply queue",
          status: "succeeded",
          duration_s: 20,
          detail: "2 need replies; PHI gate armed",
        },
      ],
      artifacts: [
        { label: "Baptist Memphis - Reviews", href: "/locations/baptist-memphis/reviews" },
      ],
      log: [
        {
          ts: "2026-07-01T11:02:20Z",
          level: "info",
          msg: "no PHI stored; reviewer names truncated",
        },
      ],
    },
    {
      id: "run-008",
      kind: "nap_drift_check",
      label: "Scheduled NAP drift check - fleet",
      trigger: "scheduled",
      triggered_by: "Scheduler (Mon 07:00)",
      status: "partial",
      ...
      steps: [
        {
          name: "Crawl monitored directories",
          status: "succeeded",
          duration_s: 540,
          detail: "66/69 directories responded",
        },
        {
          name: "Diff against canonical NAP",
          status: "succeeded",
          duration_s: 60,
          detail: "4 drift candidates queued",
        },
        {
          name: "Retry unreachable directories",
          status: "failed",
          duration_s: 20,
          detail: "3 directories timed out - retry scheduled",
        },
      ],
      artifacts: [{ label: "NAP monitor", href: "/locations/baptist-memphis/citations" }],
      log: [
        { ts: "2026-06-29T12:09:00Z", level: "warn", msg: "3 timeouts after 2 retries" },
        { ts: "2026-06-29T12:10:20Z", level: "info", msg: "drift queue: 4 items" },
      ],
    },
    {
      id: "run-007",
      kind: "keyword_scan",
      label: "Keyword scan - Baptist Collierville",
      trigger: "manual",
      triggered_by: "Agency Operator",
      status: "succeeded",
      started_at: "2026-06-23T19:45:00Z",
      duration_s: 420,
      provider: "searchatlas",
      calls: 5,
      errors: 0,
      cost_usd: 0,
      cost_note: "plan credits",
      location_scope: "Baptist Memorial Hospital - Collierville",
      source: "synthetic",
      steps: [
        {
          name: "Queue grid scans",
          status: "succeeded",
          duration_s: 10,
          detail: "5 keywords x 10x10 grid",
        },
        {
          name: "Collect pin ranks",
          status: "succeeded",
          duration_s: 380,
          detail: "500 pins ranked",
        },
        {
          name: "Write snapshots",
          status: "succeeded",
          duration_s: 30,
          detail: "scan history updated",
        },
      ],
      artifacts: [
        { label: "Collierville - Geo-Grid", href: "/locations/baptist-collierville/geo-grid" },
      ],
      log: [{ ts: "2026-06-23T19:52:40Z", level: "info", msg: "avg rank 6.2" }],
    },
    {
      id: "run-006",
      kind: "ai_surface_check",
      label: "AI spot check - Baptist DeSoto (retry)",
      trigger: "manual",
      triggered_by: "Agency Operator",
      status: "failed",
      started_at: "2026-06-22T20:15:00Z",
      duration_s: 95,
      provider: "dataforseo",
      calls: 6,
      errors: 6,
      cost_usd: 0.13,
      cost_note: "billed - failed calls still metered",
      location_scope: "Baptist Memorial Hospital - DeSoto",
      source: "synthetic",
      steps: [
        {
          name: "Fire 6-surface check",
          status: "failed",
          duration_s: 95,
          detail: "Provider queue congestion - all 6 checks timed out",
        },
      ],
      artifacts: [],
      log: [
        {
          ts: "2026-06-22T20:16:50Z",
          level: "error",
          msg: "timeout x6 (provider 5xx) - retried successfully in run-014",
        },
      ],
    },
  ],
...
export const DASHBOARD_REPORTS: ReportsFixture = {
  source: "synthetic",
  generated_at: "2026-07-10T00:00:00Z",
  note: "Reports library for the 5-location fleet",
  reports: [
    {
      id: "rep-006",
      kind: "gbp_audit_pdf",
      title: "GBP Audit - Baptist Memphis",
      description: "Scorecard, categories, photos, review velocity",
      scope: "Baptist Memorial Hospital - Memphis",
      format: "PDF",
      created_at: "2026-06-26T16:06:00Z",
      created_by: "Agency Operator",
      size_kb: 2140,
      href: "/locations/baptist-memphis/gbp-health",
      source: "dataforseo",
    },
    {
      id: "rep-005",
      kind: "fleet_lvi",
      title: "Fleet LVI Summary - June 2026",
      description: "Portfolio LVI, band distribution, movers and decliners across all 5 locations",
      scope: "All 5 locations",
      format: "PDF",
      created_at: "2026-06-30T20:00:00Z",
      created_by: "Scheduler (monthly)",
      size_kb: 890,
      href: "/local",
      source: "synthetic",
    },
    {
      id: "rep-004",
      kind: "ai_evidence_pack",
      title: "AI Visibility Evidence Pack - Fleet bake",
      description: "Methodology card, per-check receipts and answer excerpts",
      scope: "All 5 locations",
      format: "ZIP",
      created_at: "2026-06-30T19:10:00Z",
      created_by: "Agency Operator",
      size_kb: 4320,
      href: "/system/runs/run-014",
      source: "dataforseo",
    },
    {
      id: "rep-003",
      kind: "citations_csv",
      title: "Citations Export - Fleet baseline",
      description: "Directories x 5 locations with status, authority, pipeline stage",
      scope: "All 5 locations",
      format: "CSV",
      created_at: "2026-06-27T21:35:00Z",
      created_by: "Agency Operator",
      size_kb: 310,
      href: "/locations/baptist-memphis/citations",
      source: "synthetic",
    },
    {
      id: "rep-002",
      kind: "review_summary",
      title: "Review Health - Q2 2026",
      description: "Ratings, response rates and reply-time percentiles by location",
      scope: "All 5 locations",
      format: "PDF",
      created_at: "2026-06-24T09:00:00Z",
      created_by: "Scheduler (quarterly)",
      size_kb: 1260,
    ...
    {
      id: "rep-001",
      kind: "geo_grid_snapshot",
      title: "Geo-Grid Snapshot - Baptist Memphis",
      description: "10x10 grid, 3 scan history, ATRP/SoLV trends",
      scope: "Baptist Memorial Hospital - Memphis",
      format: "PDF",
...
export const DASHBOARD_LOCATIONS_FILE: LocationsFile = {
  generated_at: "2026-07-10T00:00:00Z",
  source_note: "Seeded from DataForSEO business listings",
